...
import image_imageview_49 from '../../../Assets/Brand/Airbnb_logo.png';
import image_imageview_50 from '../../../Assets/Brand/Airbnb_logo_icon.png';
import image_imageview_173 from '../../../Assets/Stays/Stay1_Main/Guest_favorite_left.png';
import image_imageview_174 from '../../../Assets/Stays/Stay1_Main/Guest_favorite_right.png';
import image_imageview_1123 from '../../../Assets/Social_media/facebook.png';
import image_imageview_1223 from '../../../Assets/Social_media/twitter.png';
import image_imageview_1323 from '../../../Assets/Social_media/instagram.png';
import image_imageview_113 from '../../../Assets/Social_media/facebook.png';
import image_imageview_123 from '../../../Assets/Social_media/twitter.png';
import image_imageview_133 from '../../../Assets/Social_media/instagram.png';
import styles from './stay1.module.css';
 ...
 * @type {React.FC}
 * 
 * @returns {React.ReactElement} The Stay1 component.
 */
const Stay1 = () =>{
    ...
    function aguaRender() {
        return(
            <main custom-agua-item="screen"  className={styles.Stay1}>
                
<section custom-agua-item="layer" className={styles.saty1header}   >
<section custom-agua-item="layer" className={styles.stay1navbar}   >
<section custom-agua-item="layer" className={styles.stay1headerdesktopsearch}   >
<section custom-agua-item="layer" className={styles['layer-951-d4974d6ba1994226a8890c7ff51c04e5']}   >
<section custom-agua-item="layer" className={styles['layer-955-f2e632efe9544455bf8d1465e26c1712']}   >
<p custom-agua-item="text" className={styles['text-769-e26342e8ffe44c89a07401e1d57ae97a']}   >Anywhere</p>
</section>
<section custom-agua-item="layer" className={styles['layer-956-84c4970aa3764c0bbe789a1096985f20']}   >
<p custom-agua-item="text" className={styles['text-770-bf242554cfb64bd6b74ea4a56a72fc53']}   >Any week</p>
</section>
<section custom-agua-item="layer" className={styles['layer-957-aa3b0564c0234919b2dbccdebb9514e6']}   >
<p custom-agua-item="text" className={styles['text-771-7ba3cdf53e6d4918bac32bd8fe94b7a0']}   >Add guests</p>
</section>
<section custom-agua-item="layer" className={styles['layer-958-71585882ec064122b759bcbe7acc70f1']}   >
<span custom-agua-item="icon" className={styles['icon-226-5b66e387930d4ade9f2c50d57f237b5f']}  >search</span>
</section>
</section>
</section>
<section custom-agua-item="layer" className={styles['layer-953-c219a9ba0e044f9a97c62594ade83a46']}   >
<Link to="/Home"><img custom-agua-item="imageView" className={styles['imageview-49-f67136a724de478a95251170c29fd7f8']}  alt="imageview-49" src={ image_imageview_49}  /></Link>
<Link to="/Home"><img custom-agua-item="imageView" className={styles['imageview-50-e4c71d821e7041098d10ac500eb31e8a']}  alt="imageview-50" src={ image_imageview_50}  /></Link>
</section>
<section custom-agua-item="layer" className={styles.stay1headermobilesearch}   >
<section custom-agua-item="layer" className={styles['layer-9552-246c62c436aa48c6809b7ea08f098aee']}   >
<p custom-agua-item="text" className={styles['text-7692-7b63600f12c24ca38632fcec075a382f']}   >Anywhere</p>
</section>
<section custom-agua-item="layer" className={styles['layer-9562-341463264ec844759c2ef291b93ab593']}   >
<p custom-agua-item="text" className={styles['text-7702-88e44514b2ae4a2db50e060ccb87b592']}   >Any week</p>
</section>
<section custom-agua-item="layer" className={styles['layer-9572-a7867cd68082429187a6728f94f445a5']}   >
<p custom-agua-item="text" className={styles['text-7712-3e963082dd654da99deacc62e560ab4b']}   >Add guests</p>
</section>
<section custom-agua-item="layer" className={styles['layer-9582-a754195977894adb838e15381b0b8467']}   >
<span custom-agua-item="icon" className={styles['icon-2262-d370e6ef7d0e40eb91198200c0389ac2']}  >search</span>
</section>
</section>
...
<span custom-agua-item="icon" className={styles['icon-305-36eca02989a74bc0b57c3b340e375da9']}  >person_outline</span>
</section>
</section>
</section>
</section>
...
<section custom-agua-item="layer" className={styles['layer-741-e31b260143c74ccfbf09d6c63f751d2d']}   >
<span custom-agua-item="icon" className={styles['icon-337-3e502967c27346c5ab0490758ff80a13']}  >favorite</span>
</section>
</section>
</section>
...
<section custom-agua-item="layer" className={styles['layer-1910-b65d38cfa79640aca9a4ae2d855b62f8']}   >
<Link to="/Stay1photos"><section custom-agua-item="layer" className={styles['layer-947-5a2fbcf7f3fe487b9bfb65d87c3511ee']}   ></section></Link>
</section>
<section custom-agua-item="layer" className={styles['layer-1911-820eb6b75c8440589c7c6c66365419a5']}   >
<Link to="/Stay1photos"><section custom-agua-item="layer" className={styles['layer-948-af219b1155dd456ba2c28507d6dce085']}   ></section></Link>
</section>
<section custom-agua-item="layer" className={styles['layer-1912-1af5a21d6ba94af9a9b5922221d88f47']}   >
<Link to="/Stay1photos"><section custom-agua-item="layer" className={styles['layer-949-227d59edae1b41d4a4095260d1052cdd']}   ></section></Link>
</section>
<section custom-agua-item="layer" className={styles['layer-1913-0c48bdb7146f42008ec611ea8f58cf73']}   >
<Link to="/Stay1photos"><section custom-agua-item="layer" className={styles['layer-950-3d014038ed854a9db158fe1dfa27a67f']}   ></section></Link>
</section>
<section custom-agua-item="layer" className={styles['layer-1914-937ac44ca6eb47a1bb078347dd4cfada']}   >
<Link to="/Stay1photos"><section custom-agua-item="layer" className={styles['layer-951-24d123355f8242e3b5a0f0e73254fd13']}   ></section></Link>
</section>
<section custom-agua-item="layer" className={styles['layer-1915-24194c74e9f444eab3f215b149c5f736']}   >
<Link to="/Stay1photos"><section custom-agua-item="layer" className={styles['layer-952-99a9b1d678e440a89dbab58f921c1d7b']}   ></section></Link>
</section>
<section custom-agua-item="layer" className={styles['layer-1916-bb5d351db8fe47a1a600b36b5826d373']}   >
<Link to="/Stay1photos"><section custom-agua-item="layer" className={styles['layer-953-6e3c709fecc04612b7a2bbc59a01bceb']}   ></section></Link>
</section>
</section>
</section>
...
<p custom-agua-item="text" className={styles['text-2870-23b2b7a8982441f3b906c254626c821e']}   >Poconos - Views - Streams - Hot Tub - Family Fun!</p>
<section custom-agua-item="layer" className={styles['layer-3497-38b3574aba0d4b7cafa7dbbab23bdd54']}   >
<section custom-agua-item="layer" className={styles['layer-3498-9f1a877f1a7443be952d6f2bcb7a3751']}   >
<span custom-agua-item="icon" className={styles['icon-985-3c38b0195ca14f65bc6d32152926c0af']}  >ios_share</span>
<p custom-agua-item="text" className={styles['text-2872-82c01c58d00a4d718d88a62a317c24c5']}   >Share</p>
</section>
<section custom-agua-item="layer" className={styles['layer-3499-209d212ada094dbea87eb2993992f5a2']}   >
<span custom-agua-item="icon" className={styles['icon-986-785fd33026b041679613402e8c0c99ea']}  >favorite</span>
<p custom-agua-item="text" className={styles['text-2873-0d9df87c4ac44204b3925523d85e2330']}   >Save</p>
</section>
</section>
</section>
<section custom-agua-item="layer" className={styles.stay1bodysection2}   >
<Link to="/Stay1photos"><section custom-agua-item="layer" className={styles['layer-3363-2c4c53621be4423a816cece6de378c83']}   ></section></Link>
...
<section custom-agua-item="layer" className={styles['layer-3504-703b890272f04a82ba14e023829384da']}   ></section>
<section custom-agua-item="layer" className={styles['layer-3507-b193e498e35b47bf9aa78e4ac8b0da6e']}   ></section>
</section>
<section custom-agua-item="layer" className={styles['layer-3508-ba7c8b965d47437a843e4b242f052127']}   >
<section custom-agua-item="layer" className={styles['layer-3506-dc3fb20bc9e84b1bbe6649951e650ec5']}   ></section>
...
<p custom-agua-item="text" className={styles['text-2896-5ac63062baf646358cccd5c4920e68a1']}   >Entire cottage in Milford, Pennsylvania</p>
<p custom-agua-item="text" className={styles['text-2897-321ffcbe3cbf4877b18993926cbbf7e0']}   >8 guests | 3 bedrooms | 5 beds | 2.5 baths</p>
</section>
<section custom-agua-item="layer" className={styles['layer-3530-bf1dc9ea573c42b8893781527a3fed37']}   >
<section custom-agua-item="layer" className={styles['layer-3531-bb94228b9bdb46f29665335c726dd63b']}   >
<img custom-agua-item="imageView" className={styles['imageview-173-b942ad5860024973bf8da643fbba05a0']}  alt="imageview-173" src={ image_imageview_173}  />
<p custom-agua-item="text" className={styles['text-2898-1bc20ba714af41a683fdc63bfac28fef']}   >Guest
favorite</p>
<img custom-agua-item="imageView" className={styles['imageview-174-d14a4502ffaf4cfeb1cf485a4a25addf']}  alt="imageview-174" src={ image_imageview_174}  />
</section>
<section custom-agua-item="layer" className={styles['layer-3532-340ec82e123f457fb38b68229a8689c3']}   >
<p custom-agua-item="text" className={styles['text-2899-c66d91d75dc14a05a1516fb8d1e66104']}   >One of the most loved homes on Airbnb, according to guests</p>
</section>
<section custom-agua-item="layer" className={styles['layer-3533-d406227d14334e0b918ca97669920676']}   >
<p custom-agua-item="text" className={styles['text-2900-4f9253ea0bfb4a68af2cc3062281a38d']}   >4.94</p>
<section custom-agua-item="layer" className={styles['layer-3534-29dc014097884864981b7e3ca4092386']}   >
<span custom-agua-item="icon" className={styles['icon-990-64089a0df5204e6cb4d2d136e17136cc']}  >star_purple500</span>
<span custom-agua-item="icon" className={styles['icon-991-f4e9ec5f2dd040f8b4b1136ff6b2349a']}  >star_purple500</span>
<span custom-agua-item="icon" className={styles['icon-992-fb11eb72c52141e381e1d6723a78876a']}  >star_purple500</span>
<span custom-agua-item="icon" className={styles['icon-993-2d01de86f04c4d10a16409064f67c8c7']}  >star_purple500</span>
<span custom-agua-item="icon" className={styles['icon-994-ff34230059124b9e808756144e9a677e']}  >star_purple500</span>
</section>
</section>
<section custom-agua-item="layer" className={styles['layer-3535-3c0e1ef243a74ec39e696ec9a276181d']}   >
<p custom-agua-item="text" className={styles['text-2901-f8fd75f1e40d4437b01f9e93b418b95e']}   >101</p>
<p custom-agua-item="text" className={styles['text-2902-c4662fb47f5b4e6ab50ff6cb196bf069']}   >Reviews</p>
</section>
</section>
<section custom-agua-item="layer" className={styles.stay1mobilesection2}   >
<span custom-agua-item="icon" className={styles['icon-9882-fb2b4611eef1482cba4cdf000457c51a']}  >local_offer</span>
<p custom-agua-item="text" className={styles['text-1606-c1e06e7fd9dc40d7b200b7522e6de55f']}   >Good price.Your dates are $133 less than the avg. nightly rate over the last 3 months.</p>
</section>
...
<section custom-agua-item="layer" className={styles['layer-1001-bf9743b26c7d49b581518304744cfe23']}   >
<p custom-agua-item="text" className={styles['text-807-38d621adce6a4061b8bd6b9aa8424fb2']}   >Fast wifi
</p>
<p custom-agua-item="text" className={styles['text-808-71048d3c486c49d6a9f7dfc244f5166d']}   >At 408 Mbps, you can take video calls and stream videos for your whole group.
</p>
</section>
</section>
<section custom-agua-item="layer" className={styles['layer-995-1831c4299c5a4dee8f712288430cbd70']}   >
<span custom-agua-item="icon" className={styles['icon-275-ab33b21371464411b05b62abf67c23f8']}  >door_front</span>
<section custom-agua-item="layer" className={styles['layer-999-33d2a4d2b54e470d9d94687942eb86fd']}   >
<p custom-agua-item="text" className={styles['text-805-72e95f3a4ce84e2191a29d9908455cb5']}   >Self check-in
</p>
<p custom-agua-item="text" className={styles['text-806-d9d3e0f318c64bd8921b3ce0bc261664']}   >Check yourself in with the keypad.
</p>
</section>
</section>
<section custom-agua-item="layer" className={styles['layer-996-54393bf12f0d4054853e0478e9ae7ede']}   >
<span custom-agua-item="icon" className={styles['icon-276-7a0509a5b3284a0489020b866fd51dd9']}  >workspace_premium</span>
<section custom-agua-item="layer" className={styles['layer-1000-04587e82078948e3acc5bf4cdaf91488']}   >
<p custom-agua-item="text" className={styles['text-803-c33c6dd30db94349aef0c9092a82519e']}   >Stacy And Matt is a Superhost
</p>
<p custom-agua-item="text" className={styles['text-804-84668652748e43acba44ea62a1903586']}   >Superhosts are experienced, highly rated Hosts.</p>
</section>
</section>
</section>
...
<section custom-agua-item="layer" className={styles['layer-1385-d070f4d52b394389b5856bac1176fab7']}   >
<p custom-agua-item="text" className={styles['text-1099-194cb286a7184d1093310211d38e9a6e']}   >Show more</p>
...
<section custom-agua-item="layer" className={styles['layer-1380-195dc783a93148d18164be8e5ce9b27c']}   >
<section custom-agua-item="layer" className={styles['layer-1382-0d083cd8cdcf4383ae5e0c622e40ade1']}   ></section>
<p custom-agua-item="text" className={styles['text-1111-65dd588b5a2c4799b57d56cd01c0a60d']}   >Bedroom 1</p>
<p custom-agua-item="text" className={styles['text-1109-d28d7be627514774b1cfec1d53ddf49c']}   >1 queen bed</p>
</section>
<section custom-agua-item="layer" className={styles['layer-1379-018a4477727c45a7965eed3de23ca205']}   >
<section custom-agua-item="layer" className={styles['layer-1383-56ada1a8283e42fcb632fbf71b95a67f']}   ></section>
<p custom-agua-item="text" className={styles['text-1110-b62e9c06bb6241a89fef7870518e3cfc']}   >Bedroom 2</p>
<p custom-agua-item="text" className={styles['text-1112-f07bc849e4264f678274c61d9f48a046']}   >1 queen bed</p>
</section>
<section custom-agua-item="layer" className={styles['layer-1381-950c5b3877b2472da9e0412087a297d3']}   >
<section custom-agua-item="layer" className={styles['layer-1384-c111860067784aafa7e79691f7e7d55f']}   ></section>
<p custom-agua-item="text" className={styles['text-1114-a9284d39681146dcb03bdc522558a344']}   >Bedroom 3
</p>
<p custom-agua-item="text" className={styles['text-1113-19c754ab790847b58429ef678944593f']}   >1 double bed, 2 single beds</p>
</section>
</section>
</section>
...
<section custom-agua-item="layer" className={styles['layer-1010-26d586fc6f874285a9c9c2aae575731d']}   >
<span custom-agua-item="icon" className={styles['icon-277-cc959a5539e7407eaba42135906a298e']}  >houseboat</span>
<p custom-agua-item="text" className={styles['text-811-6b0df01ae9444c75a39288a9de2b72b9']}   >River view</p>
</section>
<section custom-agua-item="layer" className={styles['layer-1011-90961c9b1969430884a3da5e56d0dece']}   >
<span custom-agua-item="icon" className={styles['icon-278-7ae2e061c2fd40d7a03df8e50bb192fb']}  >landscape</span>
<p custom-agua-item="text" className={styles['text-812-3910d24bae164deeb46bb14cc3764f76']}   >Valley view</p>
</section>
</section>
<section custom-agua-item="layer" className={`${styles['layer-1006-1508c606a6184c68ac04fe710183dd15-orientation']} ${styles['layer-1006-1508c606a6184c68ac04fe710183dd15']}`}   >
<section custom-agua-item="layer" className={styles['layer-1012-8b5866d50ba2404196264a9318be1c6b']}   >
<span custom-agua-item="icon" className={styles['icon-279-035262bb636b4e8b959735957d134556']}  >houseboat</span>
<p custom-agua-item="text" className={styles['text-813-43d9c84270b048aea76d6a1501a1a293']}   >Waterfront</p>
</section>
<section custom-agua-item="layer" className={styles['layer-1013-e082b09e0fa3404eb8dafa6829c1a149']}   >
<span custom-agua-item="icon" className={styles['icon-280-acc7ab70d3264ae38ba5bd061cfe75fb']}  >kitchen</span>
<p custom-agua-item="text" className={styles['text-814-d3d03740ead1411e8e560494e147ca96']}   >Kitchen</p>
</section>
</section>
<section custom-agua-item="layer" className={`${styles['layer-1007-d00860f868614c13836e9138699c4302-orientation']} ${styles['layer-1007-d00860f868614c13836e9138699c4302']}`}   >
<section custom-agua-item="layer" className={styles['layer-1014-5ba6038092cd479486f4a37f62eb01b6']}   >
<span custom-agua-item="icon" className={styles['icon-281-67a3ecddbf8442b6a82a913eb602cbc7']}  >wifi</span>
<p custom-agua-item="text" className={styles['text-815-52b43d505d9f4f9fba5bfac5aec27c66']}   >Fast wifi – 408 Mbps</p>
</section>
<section custom-agua-item="layer" className={styles['layer-1015-a270f66c3e7341658b4ca0ffda4e6cf7']}   >
<span custom-agua-item="icon" className={styles['icon-282-b7a89b02e1d2476dbf1bcad3806da92c']}  >directions_car</span>
<p custom-agua-item="text" className={styles['text-816-a29d0218a2c942f09ea7ed903a405cd7']}   >Free parking on premises</p>
</section>
</section>
<section custom-agua-item="layer" className={`${styles['layer-1008-5f96c11ad57c44c7a94aa570f90d13bf-orientation']} ${styles['layer-1008-5f96c11ad57c44c7a94aa570f90d13bf']}`}   >
<section custom-agua-item="layer" className={styles['layer-1016-bafe2c5841294a0bbf4ea779dea1947c']}   >
<span custom-agua-item="icon" className={styles['icon-283-f1043e5d99a14cde885ef24dabdaae4b']}  >hot_tub</span>
<p custom-agua-item="text" className={styles['text-817-db36862f5909495a8ffa322a1f18a90f']}   >Private hot tub - available all year, open 24 hours</p>
</section>
<section custom-agua-item="layer" className={styles['layer-1017-845e81cb16404d29af8316489bfa9572']}   >
<span custom-agua-item="icon" className={styles['icon-284-5a853f5746bf4f0cbf78e360df5ca2d9']}  >pets</span>
<p custom-agua-item="text" className={styles['text-818-e2acc881573f4dfe8d2141a99065d446']}   >Pets allowed
</p>
</section>
</section>
<section custom-agua-item="layer" className={`${styles['layer-1009-6703562d38d24144a901f21e8e38d9d4-orientation']} ${styles['layer-1009-6703562d38d24144a901f21e8e38d9d4']}`}   >
<section custom-agua-item="layer" className={styles['layer-1018-4749c41989dc4655868fc662933af5ad']}   >
<span custom-agua-item="icon" className={styles['icon-285-fd50225c0e9147adbc3c635427d312fb']}  >connected_tv</span>
<p custom-agua-item="text" className={styles['text-819-606ed6d42de74bb5b1f52d21ee5f98e0']}   >60" HDTV with Roku, standard cable</p>
</section>
<section custom-agua-item="layer" className={styles['layer-1019-10280e222afb488c94ecf90de9b4e5b7']}   >
<span custom-agua-item="icon" className={styles['icon-286-6f4fed5260c94a44b7800202d355144f']}  >dry_cleaning</span>
<p custom-agua-item="text" className={styles['text-820-5625339adbb74ada8cd340a3dd63780e']}   >Free washer – In unit</p>
</section>
</section>
<section custom-agua-item="layer" className={styles['layer-1377-14133f0b433d4641a5fe88ad4db45f8e']}   >
<p custom-agua-item="text" className={styles['text-1107-d1704ccc781d4620a91a8d70654f8673']}   >Show all 60 amenities</p>
</section>
</section>
</section>
<section custom-agua-item="layer" className={styles.stay1bodysection3b}   >
<section custom-agua-item="layer" className={styles['layer-3513-86f6deabeb974118b8536a58b3a67538']}   >
<section custom-agua-item="layer" className={styles['layer-3527-d44a0735f356448fa36428af87748052']}   >
<p custom-agua-item="text" className={styles['text-2876-fbc1aeaefd514ecb8513a17d7ad5730d']}   >$350</p>
<p custom-agua-item="text" className={styles['text-2893-253e082909ee4b69ad0b763082110d06']}   >night</p>
</section>
<section custom-agua-item="layer" className={styles['layer-3516-9743622e1b994c61837d9fb16d23b934']}   >
<section custom-agua-item="layer" className={styles['layer-3517-544ef4b0132845bfbb65003340325216']}   >
<section custom-agua-item="layer" className={styles['layer-3519-ef07daacd9634b38b59aa067d0ab75e6']}   >
<p custom-agua-item="text" className={styles['text-2877-897053c32813499e8bbf80ae8ef46950']}   >CHECK-IN</p>
<p custom-agua-item="text" className={styles['text-2878-1d105c1f227c4f8d94e99d23b5c0af9e']}   >1/22/2024</p>
</section>
<section custom-agua-item="layer" className={styles['layer-3520-a68da881fd6b402189d1a96b2470ca04']}   >
<p custom-agua-item="text" className={styles['text-2879-b392572f4d3341688a4b2cfa82b3c1a8']}   >CHECKOUT</p>
<p custom-agua-item="text" className={styles['text-2880-e5ccec8c65e745689696c83d59decb3c']}   >1/28/2024</p>
</section>
</section>
<section custom-agua-item="layer" className={styles['layer-3518-76ee813616be497ab4d8606966a627ca']}   >
<section custom-agua-item="layer" className={styles['layer-3521-b8746880c56544c89050532aa3609945']}   >
<p custom-agua-item="text" className={styles['text-2881-52e43a77004540dfa1925650cb870304']}   >GUESTS</p>
<p custom-agua-item="text" className={styles['text-2882-d03de843450f4179b80b7d58f5639e02']}   >1 guest</p>
</section>
<span custom-agua-item="icon" className={styles['icon-989-c21d3b2843c44bd39a782b388a664865']}  >keyboard_arrow_down</span>
</section>
</section>
<section custom-agua-item="layer" className={styles['layer-3522-73ddf5c8ad0843c889f171746867a3dc']}   onClick={() => openInNewTab("https://www.airbnb.com/book/stays/53050214?numberOfAdults=1&numberOfChildren=0&numberOfInfants=0&numberOfPets=0&checkin=2024-01-22&checkout=2024-01-28&guestCurrency=COP&productId=53050214&isWorkTrip=false&numberOfGuests=1&photoId=1325053452")}>
<p custom-agua-item="text" className={styles['text-2883-34ecd72a04984497b39d138ca2c4b309']}   >Reserve</p>
</section>
<section custom-agua-item="layer" className={styles['layer-1492-757dd44ba2b2467d85ee48bd05075724']}   >
<p custom-agua-item="text" className={styles['text-2884-fad7af4892364c4b9cbbaaaa1c170581']}   >You won't be charged yet</p>
</section>
<section custom-agua-item="layer" className={styles['layer-1386-4b99ad28cd3a48adbcadd01cd6ab39e8']}   >
<section custom-agua-item="layer" className={styles['layer-3523-5ef4cb76ef5a43489e63a8fd3a69a6f1']}   >
<p custom-agua-item="text" className={styles['text-2891-10bbacb2cabc48f88ad6d8042b3bbd78']}   >$350 x 6 nights</p>
<p custom-agua-item="text" className={styles['text-2892-2e22cbeee233406bbb128329373d9eef']}   >$2,098</p>
</section>
<section custom-agua-item="layer" className={styles['layer-3524-1c717e17fd3f416abb368955542a79da']}   >
<p custom-agua-item="text" className={styles['text-2889-5d964f12dcc041f99d369ddef1380404']}   >Cleaning fee</p>
<p custom-agua-item="text" className={styles['text-2890-5b4d766ef0d7464780d181203f1396ac']}   >$165</p>
</section>
<section custom-agua-item="layer" className={styles['layer-3525-718b8057cd454c89b531e3355937c4ff']}   >
<p custom-agua-item="text" className={styles['text-2885-227b3fdf3a4e476f8b6fe9449b007be2']}   >Airbnb service fee</p>
<p custom-agua-item="text" className={styles['text-2888-5fdcf6bde6b34bff84d151906131836a']}   >$319</p>
</section>
</section>
<section custom-agua-item="layer" className={styles['layer-3528-551a8c880c5942c795aa2aa263af76dc']}   >
<p custom-agua-item="text" className={styles['text-2894-e2b0438b9de149eaa00c6fa532dbd670']}   >Total before taxes</p>
<p custom-agua-item="text" className={styles['text-2895-fd25fa4ec1ef406f9ca82451ea035b9a']}   >$2,582</p>
</section>
</section>
<section custom-agua-item="layer" className={styles['layer-3514-155ed48ee892470e8c1ab32778885387']}   >
<p custom-agua-item="text" className={styles['text-2875-53fabede94094f45a2e4f4a4357751ac']}   >Good price. Your dates are $133 less than the avg. nightly rate over the last 3 months.</p>
<span custom-agua-item="icon" className={styles['icon-988-76089dd48d034190a5b0636ef156b707']}  >local_offer</span>
</section>
<section custom-agua-item="layer" className={styles['layer-3515-063f3d0d6630490093e0c2f54b2727a0']}   >
<span custom-agua-item="icon" className={styles['icon-987-d4615ab8e0664832b6603dd589d494d2']}  >flag</span>
<p custom-agua-item="text" className={styles['text-2874-cdeea66e9b2a450097c330989d3c1b6f']}   >Report this listing</p>
</section>
</section>
</section>
...
<section custom-agua-item="layer" className={styles['layer-35122-57eb42295d0d49109e9d18aed619e492']}   >
<IframeHTMLStringComponent title={""} sourcedoc={"<iframe id=\"map-canvas\" class=\"map_part\" width=\"326\"  height=\"218\"  frameborder=\"0\" scrolling=\"no\" marginheight=\"0\" marginwidth=\"0\" src=\"https://maps.google.com/maps?width=100%&amp;height=100%&amp;hl=en&amp;q=41.35003,-74.86325,&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed\">Powered by <a href=\"https://embedgooglemaps.com\">how to embed google maps generator</a> and <a href=\"https://gamstopcancel.com/\">can you cancel gamstop</a></iframe>"} width={"100%"} height={"100%"}  />
</section>
</section>
<p custom-agua-item="text" className={styles['text-733-05071f2e6d2f408a99bf2a79fa03f1a1']}   >Milford, Pennsylvania, United States
</p>
<p custom-agua-item="text" className={styles['text-734-072ca6f254f641d7b3237aed1e8b626c']}   >The cottage itself is in a secluded, wooded setting, but is only a few minutes to the lovely small town of Milford. Milford has a nice, walkable main street with many restaurants, cafes and shops.</p>
...
<section custom-agua-item="layer" className={styles.stay1footer}   >
<section custom-agua-item="layer" className={styles.homefootershared2}   >
<section custom-agua-item="layer" className={`${styles['layer-2132-5dd3a4819f6a4417b59fe707ca3c4edc-orientation']} ${styles['layer-2132-5dd3a4819f6a4417b59fe707ca3c4edc']}`}   >
<section custom-agua-item="layer" className={styles['layer-2152-9bcc8da4827445338b2cb6a679a4a35c']}   >
<p custom-agua-item="text" className={styles['text-1702-922e8b3bd69e45e78fb5994e5d651304']}   >Support</p>
<p custom-agua-item="text" className={styles['text-1712-9d411cbf1f9a4ce7904ee4b2688fe957']}   onClick={() => openInNewTab("https://www.airbnb.com/help/home")}>Help Center</p>
<p custom-agua-item="text" className={styles['text-1722-3ce2a23238bd4fb992f9f79ee0abc6c3']}   onClick={() => openInNewTab("https://www.airbnb.com/aircover")}>AirCover</p>
<p custom-agua-item="text" className={styles['text-1732-d3e9a7ec341d45f69a360547f4c77f0f']}   onClick={() => openInNewTab("https://www.airbnb.com/against-discrimination")}>Anti-discrimination
</p>
<p custom-agua-item="text" className={styles['text-1742-a00f9402379f485c9e31194c937cada0']}   onClick={() => openInNewTab("https://www.airbnb.com/accessibility")}>Disability support
</p>
...
<p custom-agua-item="text" className={styles['text-1782-5b0f54fa663c4e12854acda7cb45071e']}   onClick={() => openInNewTab("https://www.airbnb.com/host/homes")}>Airbnb your home
</p>
<p custom-agua-item="text" className={styles['text-1792-49ac4e25ceea445ba82d8b62310c8a8c']}   onClick={() => openInNewTab("https://www.airbnb.com/aircover-for-hosts")}>AirCover for Hosts
</p>
<p custom-agua-item="text" className={styles['text-1802-00e2024459184902bb1d88b8289da581']}   onClick={() => openInNewTab("https://www.airbnb.com/resources")}>Hosting resources
</p>
<p custom-agua-item="text" className={styles['text-1812-3178f31647034febac48880a525f316a']}   onClick={() => openInNewTab("https://www.airbnb.com/help/community")}>Community forum
</p>
<p custom-agua-item="text" className={styles['text-1822-ceb04ab4173b40acb720552bc59aacc5']}   onClick={() => openInNewTab("https://www.airbnb.com/help/responsible-hosting")}>Hosting responsibly
</p>
...
<p custom-agua-item="text" className={styles['text-1852-1f6b5b074566479f9ef83ff437a9ece3']}   onClick={() => openInNewTab("https://www.airbnb.com/press/news")}>Newsroom
</p>
<p custom-agua-item="text" className={styles['text-1862-2ec77d4c60cb4f4fad551b5f4aa95ea6']}   onClick={() => openInNewTab("https://www.airbnb.com/release")}>New features
</p>
<p custom-agua-item="text" className={styles['text-1872-62bb096ba84143c3a4f24a5109c72df7']}   onClick={() => openInNewTab("https://www.airbnb.com/careers")}>Careers</p>
<p custom-agua-item="text" className={styles['text-1882-be94b049901847f2a93c9c95e7d1581e']}   onClick={() => openInNewTab("https://investors.airbnb.com/")}>Investors</p>
<p custom-agua-item="text" className={styles['text-1892-34ccdd7d1afa461a930b111776a865da']}   onClick={() => openInNewTab("https://www.airbnb.com/giftcards")}>Gift cards
</p>
...
<span custom-agua-item="icon" className={styles['icon-20623-07a5ce44a3be46e0a625a3113537716a']}  >language</span>
<p custom-agua-item="text" className={styles['text-52023-c6ab3aec34a84e4b9f9d60ccd074da09']}   >English (US)</p>
<p custom-agua-item="text" className={styles['text-52123-fb821f07e169474582c0c6ee84f11868']}   >$USD</p>
<section custom-agua-item="layer" className={styles['layer-46323-9ca3659470344c5f83c4aae1f9105188']}   >
<img custom-agua-item="imageView" className={styles['imageview-1123-b505c0f0698c447d9ca6cd4bbd5d1f86']}  alt="imageview-1123" src={ image_imageview_1123}  onClick={() => openInNewTab("https://www.facebook.com/airbnb")}/>
<img custom-agua-item="imageView" className={styles['imageview-1223-8a4426d872c1464caba5aa597dd669b9']}  alt="imageview-1223" src={ image_imageview_1223}  onClick={() => openInNewTab("https://twitter.com/airbnb")}/>
<img custom-agua-item="imageView" className={styles['imageview-1323-f189c79dfa494883a7ccac2509b92918']}  alt="imageview-1323" src={ image_imageview_1323}  onClick={() => openInNewTab("https://instagram.com/airbnb")}/>
</section>
</section>
</section>
<section custom-agua-item="layer" className={`${styles['layer-4653-31fcfc7874e44f44bc3e2bc8713d3e6a-orientation']} ${styles['layer-4653-31fcfc7874e44f44bc3e2bc8713d3e6a']}`}   >
<section custom-agua-item="layer" className={`${styles['layer-4603-6a751f68a630456d8044746a53fef1ad-orientation']} ${styles['layer-4603-6a751f68a630456d8044746a53fef1ad']}`}   >
<p custom-agua-item="text" className={styles['text-5153-c1074ec1385a49ceaad329fbc8aa5454']}   >© 2024 Airbnb, Inc.</p>
<section custom-agua-item="layer" className={`${styles['layer-4643-533e3ea346cf4597b57d9297add6b618-orientation']} ${styles['layer-4643-533e3ea346cf4597b57d9297add6b618']}`}   >
<section custom-agua-item="layer" className={`${styles['layer-4623-836504a660464f6ca89ae54ec8511c25-orientation']} ${styles['layer-4623-836504a660464f6ca89ae54ec8511c25']}`}   >
<p custom-agua-item="text" className={styles['text-5163-c7d8c44ecbef4efeb92d1cc4d4f55000']}   onClick={() => openInNewTab("https://www.airbnb.com/terms")}>Terms</p>
<p custom-agua-item="text" className={styles['text-5173-9a2998c030bd4716acbe8902d45fac40']}   onClick={() => openInNewTab("https://www.airbnb.com/sitemaps/v2")}>Sitemap</p>
<p custom-agua-item="text" className={styles['text-5183-50dd775644484e2ab776bf8dcad4a732']}   onClick={() => openInNewTab("https://www.airbnb.com/terms/privacy_policy")}>Privacy</p>
</section>
<p custom-agua-item="text" className={styles['text-5193-269cdd14118147adb7c6970ed170348c']}   >Your Privacy Choices</p>
</section>
</section>
<section custom-agua-item="layer" className={styles['layer-4613-6dcfa51291b84c9f994d9466330070d6']}   >
<span custom-agua-item="icon" className={styles['icon-2063-bc1d7824af174910b63118c65531902a']}  >language</span>
<p custom-agua-item="text" className={styles['text-5203-db26142e95ab48868cbba7f21e060f09']}   >English (US)</p>
<p custom-agua-item="text" className={styles['text-5213-75324ad9987e431489b9e498b3c39c08']}   >$USD</p>
<section custom-agua-item="layer" className={styles['layer-4633-aa35acc206734cf99e5ae64f75dda606']}   >
<img custom-agua-item="imageView" className={styles['imageview-113-823148b827d842a5af2aa71344b922e1']}  alt="imageview-113" src={ image_imageview_113}  onClick={() => openInNewTab("https://www.facebook.com/airbnb")}/>
<img custom-agua-item="imageView" className={styles['imageview-123-50afb0991ccb4a0b8e54780d219f509d']}  alt="imageview-123" src={ image_imageview_123}  onClick={() => openInNewTab("https://twitter.com/airbnb")}/>
<img custom-agua-item="imageView" className={styles['imageview-133-360c93a51e2c485489578d0343fb3802']}  alt="imageview-133" src={ image_imageview_133}  onClick={() => openInNewTab("https://instagram.com/airbnb")}/>
</section>
</section>
</section>
</section>
